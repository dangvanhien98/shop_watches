                    ...
                    <div class="col-lg-9 col-lg-push-3 col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                <form class="form-inline" action="${pageContext.request.contextPath}/category/search" method="get">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <%
                                	...
                                	%>
                                   	<li><a href="${pageContext.request.contextPath}/category/list?start=<%=a%>&end=<%=b%>"><%= i %></a></li> 
                                   <%} %>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-lg-pull-9 col-md-3 col-md-pull-9 col-sm-12 col-xs-12 smt-40 xmt-40">
                        <div class="htc__product__leftsidebar">
                            ...
                            <div class="htc__category">
                                ...
                                <li><a href="${pageContext.request.contextPath}/category/list">Tất cả</a></li>
                                    <c:if test="${not empty lstCategory}">
                                    	<c:forEach var="category" items="${lstCategory}">
                                    		<li><a href="${pageContext.request.contextPath}/category/list?id=${category.getCategoryID()}">${ category.getCategoryName() }</a></li>
                                    	</c:forEach>
                                    </c:if>
                                </ul>
                            </div>
